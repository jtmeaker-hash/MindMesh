...
export const RoutineModule: React.FC<RoutineModuleProps> = ({ categories, contacts = [], reminders = [], directDebits = [], onRoutinesChange, appearance = getDefaultAppearance() }) => {
  ...
  return <div className="mm-module" style={{ flex: '1 1 0%', minHeight: 0, overflow: 'auto', width: '100%', padding: '24px', color: '#e2e8f0', background: '#090d16' }}>
    <div style={{ maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: selected ? 'minmax(260px, .75fr) minmax(360px, 1.5fr)' : '1fr', gap: 14, alignItems: 'start' }}>
